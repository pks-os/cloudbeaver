...
export default [
  ...
  ['settings_data_editor_disable_data_import_name', 'Отключить загрузку данных'],
  ['settings_data_editor_disable_data_import_description', 'Отключить загрузку данных для пользователей без прав администратора'],
